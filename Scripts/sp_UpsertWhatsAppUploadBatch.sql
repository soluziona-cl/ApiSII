-- =============================================
-- Stored Procedure: sp_UpsertWhatsAppUploadBatch
-- Descripción: Verifica si existe un batch con Name (Campaign) y TenantId, si existe lo actualiza, si no existe lo crea.
--              Busca por el campo Name que contiene el valor de Campaign.
...
CREATE PROCEDURE [dbo].[sp_UpsertWhatsAppUploadBatch]
    @CampaignId INT,
    @TenantId INT,
